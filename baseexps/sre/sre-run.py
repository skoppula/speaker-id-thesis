...
def create_dataflow(partition, cachedir, datadir, spkmap, sentfilt, context=50):
    ...
    if isTrain:
        rsr_ds = RandomFramesBatchFromCacheSre(cachedir, 100, context)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cachedir', help='dir to cache', default='/data/sls/scratch/skoppula/backup-exps/sre-experiments/create_sre_data_cache/trn_cache/context_50frms/')
    parser.add_argument('--datadir', help='dir to data', default='/data/sls/scratch/skoppula/kaldi-sre10/numpy/')
    parser.add_argument('--sentfilt', type=int, help='dir to data', default=None)
    parser.add_argument('--spkmap', help='dir to spk mappings', default='/data/sls/scratch/skoppula/backup-exps/sre-experiments/create_sre_data_cache/generator/spk_mappings.pickle')
