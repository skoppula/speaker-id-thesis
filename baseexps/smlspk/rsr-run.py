...
if __name__ == '__main__':
    ...
    parser.add_argument('--cachedir', help='dir to cache', default='/data/sls/scratch/skoppula/kaldi-rsr/train_cache/rsr_smlspk_512_50_20/')
    parser.add_argument('--datadir', help='dir to data', default='/data/sls/scratch/skoppula/kaldi-rsr/numpy/small_spk_idxs/')
    parser.add_argument('--sentfilt', type=int, help='dir to data', default=None)
    parser.add_argument('--spkmap', help='dir to spk mappings', default='/data/sls/scratch/skoppula/kaldi-rsr/train_cache/rsr_smlspk_512_50_20/rsr_smlspk_512_50_20_mappings.pickle')
