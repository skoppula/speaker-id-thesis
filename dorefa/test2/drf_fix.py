...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_ckpt', help='load ckpt', default='/data/sls/u/meng/skanda/home/thesis/baseexps/train_log/sentfiltNone_fcn2_bnTrue_regTrue_noLRSchedule/checkpoint')
    ...
    out_dir = '_'.join(['sentfilt' + str(args.sentfilt), 'fcn2', 'bn','w' + str(BITW), 'a' + str(BITA),'first_last_not_q'])
    if args.load_ckpt:
       out_dir += '_preload' 
